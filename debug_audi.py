"""
debug_audi.py — Audi India ka price structure dhoondo
======================================================
Audi India: A4, A6, Q3, Q5, Q7, Q8, e-tron GT, Q8 e-tron.
Ye script site structure dekhta hai.

CHALAO:
    python debug_audi.py
Phir audi_debug.txt UPLOAD kar dena.
"""
...
with sync_playwright() as p:
    ...
    try:
        ...
        kws = ["price","models","all-models","a4","a6","q3","q5","q7","q8","e-tron","etron"]
        ...
        try:
            ...
            if apis:
                ...
                for u, b in apis:
                    ...
                    names = re.findall(r'"(?:name|model|carline|title|modelName)"\s*:\s*"([^"]{2,45})"', b)
                    if names:
...
with open("audi_debug.txt", "w", encoding="utf-8") as f:
    f.write("\n".join(out))

print("\n\n" + "=" * 60)
print("HO GAYA. audi_debug.txt UPLOAD kar do.")
print("=" * 60)